...
struct esm_class
{
    ...
    {
        return { static_cast<smpp::messaging_mode>(value & 0x03), static_cast<smpp::message_type>(value & 0x3C), static_cast<smpp::gsm_network_features>(value & 0xC0) };
    }

    explicit operator uint8_t() const
    {
        return static_cast<uint8_t>(messaging_mode) | static_cast<uint8_t>(message_type) | static_cast<uint8_t>(gsm_network_features);
    }
};
} // namespace pa::smpp