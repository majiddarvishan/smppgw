...
namespace detail
{
inline auto command_id_of(const deliver_sm&)
{
    return command_id::deliver_sm;
}

template<>
inline consteval auto members<deliver_sm>()
{
    using o = deliver_sm;
    return std::tuple{ meta<c_octet_str<6>>(&o::service_type, "service_type"),
                       ...
                       meta<c_octet_str<1>>(&o::schedule_delivery_time, "schedule_delivery_time"),
                       meta<c_octet_str<1>>(&o::validity_period, "validity_period"),
